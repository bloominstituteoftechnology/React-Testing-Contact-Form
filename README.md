...
- explain what automated testing is and its importance
  Testing is essential for software quality. Testing with every commit does not scale, therefore AUTOMATED TESTING works by using software to test our code. Testing is not OPTIONAL!
